...
\newtcbtheorem[number within=chapter]{warningbox}{Attenzione}{%
  colback=red!5,
  colframe=red!35!black,
  breakable,
  fonttitle=\bfseries,
  before={\vspace{0.5cm}},
  after={\vspace{0.5cm}}}{warning}
...
\newtcblisting{commandshell}{%
  ...
  before={\vspace{0.5cm}},
  after={\vspace{0.5cm}},
  minted options={fontsize=\footnotesize,breaklines,formatcom=\BashFancyFormatLine}}
